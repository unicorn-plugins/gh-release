...
```bash
# 1. 로컬 경로를 마켓플레이스로 등록
claude plugin marketplace add ./github-release-manager
...
claude plugin marketplace update github-release-manager
...
> ```bash
> claude plugin remove github-release-manager@github-release-manager
> claude plugin marketplace update github-release-manager
> claude plugin install github-release-manager@github-release-manager
> ```
...
> `/github-release-manager:setup`을 재실행하여 누락된 도구를 설치할 것.
